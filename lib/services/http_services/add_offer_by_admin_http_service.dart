...
class AddOfferByAdminHttpService {
  static Future<bool> addOfferByAdmin(Offer offer) async {
    final addOfferByAdminURL = 'https://3ard.de/api/offer/mobile/add';
    try {
      Map request = {
      ...
      http.Response response =
          await http.post(addOfferByAdminURL, body: request);
